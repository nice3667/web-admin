...
class ReportController extends Controller
{
        ...
        try {
            ...
            $uniqueClients = $clients->groupBy('client_uid')->map(function ($group) {
                ...
                return [
                    ...
                    'rebate_amount_usd' => 0, // Not available in Janischa data
            ...
            Log::info('Janischa data formatted successfully', [
    ...
    public function clientAccount(Request $request)
    {
        try {
            ...
            Log::info('Janischa client account data formatted successfully', [
                'count' => $formattedClients->count(),
                'data_source' => $dataSource
            ]);
