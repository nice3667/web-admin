...
use App\Models\JanischaClient; // Added this import
...
class Report2Controller extends Controller
{
    ...
    public function clientAccount2Api(Request $request)
    {
        try {
            Log::info('Fetching Kantapong client account data for API...');
            ...
            Log::info('Kantapong client account data formatted successfully for API', [
                'count' => $formattedClients->count(),
                'data_source' => $dataSource
            ]);
            ...
            Log::error('Error in Report2Controller@clientAccount2Api: ' . $e->getMessage());
            Log::error($e->getTraceAsString());
