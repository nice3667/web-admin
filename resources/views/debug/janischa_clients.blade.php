...
<head>
    ...
    <title>Debug Janischa Clients - Dashboard FX</title>
            ...
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    <h1 class="h3 mb-0">
                        ...
                        Debug Janischa Clients
                    </h1>
                    <div>
                        <a href="{{ route('debug.ham-clients') }}" class="btn btn-outline-primary btn-sm me-2">
                            <i class="fas fa-users me-1"></i>Ham
                        </a>
                ...
                <p class="text-muted">ข้อมูลลูกค้าทั้งหมดของ Janischa Exness</p>
            </div>
        </div>
            ...
            <div class="col-md-3">
                <div class="card stat-card">
                    <div class="card-body text-center">
                        ...
                        <div class="stat-number">{{ count($data['monthly_stats']) }}</div>
                        <div>เดือน</div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped">
                                <thead>
                                    <tr>
                                        <th>เดือน</th>
                                        <th class="text-end">จำนวนลูกค้า</th>
                                        <th class="text-end">เปอร์เซ็นต์</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach($data['monthly_stats'] as $month)
                                        <tr>
                                            <td>{{ $month['month'] }}</td>
                                            <td class="text-end">{{ number_format($month['count']) }}</td>
                                            <td class="text-end">
                                                {{ number_format(($month['count'] / $data['total_clients']) * 100, 1) }}%
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            <a href="#" class="btn btn-outline-primary btn-sm">
                                <i class="fas fa-sync me-1"></i>Sync ข้อมูลใหม่
                            </a>
                            <a href="#" class="btn btn-outline-info btn-sm">
                                <i class="fas fa-download me-1"></i>Export ข้อมูล
                            </a>
