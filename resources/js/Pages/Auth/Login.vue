    ...
    <div class="min-h-screen relative overflow-hidden">
      ...
      <div class="relative z-10 min-h-screen flex items-center justify-center p-4">
        <div class="w-full max-w-md">
          ...
          <div class="text-center mb-8" :class="{ 'animate-fade-in-up': mounted }">
            <div class="relative inline-block mb-6">
              ...
              <div class="relative bg-white/5 backdrop-blur-xl rounded-xl p-6 border border-white/10 shadow-2xl">
            ...
            <h1 class="text-4xl font-bold mb-3 text-white drop-shadow-lg">
              Admin Portal
            </h1>
            <p class="text-blue-200 text-base font-medium">Secure Access Dashboard</p>
          </div>
          ...
          <div class="relative" :class="{ 'animate-fade-in-up animation-delay-300': mounted }">
            ...
            <CardBox class="relative bg-white/[0.05] backdrop-blur-xl border border-white/10 shadow-xl rounded-xl overflow-hidden">
                  ...
                  <div class="space-y-2">
                    ...
                    <div class="relative group">
                      <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                        <svg class="h-5 w-5 text-blue-300 group-focus-within:text-blue-200 transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <input
                        ...
                        autocomplete="email"
                        required
                        class="block w-full pl-12 pr-4 py-3.5 bg-white/5 backdrop-blur-sm border border-white/20 rounded-lg focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all duration-200 text-white placeholder-blue-200/60 shadow-inner hover:bg-white/10 hover:border-white/30"
                        :class="{ 'border-red-400/50 focus:ring-red-400/50 focus:border-red-400/50': form.errors.email }"
                        placeholder="Enter your email address"
                      />
                    </div>
                    <p v-if="form.errors.email" class="text-sm text-red-300 font-medium animate-fade-in">{{ form.errors.email }}</p>
                  </div>
                  ...
                  <div class="space-y-2">
                    ...
                    <div class="relative group">
                      ...
                      <input
                        ...
                        required
                        class="block w-full pl-12 pr-14 py-3.5 bg-white/5 backdrop-blur-sm border border-white/20 rounded-lg focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all duration-200 text-white placeholder-blue-200/60 shadow-inner hover:bg-white/10 hover:border-white/30"
                      ...
                      <button
                        ...
                        class="absolute inset-y-0 right-0 pr-4 flex items-center transition-transform duration-200 hover:scale-110"
                      >
                        <svg v-if="showPassword" class="h-5 w-5 text-blue-300 hover:text-white transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.878 9.878L3 3m6.878 6.878L21 21" />
                        </svg>
                        <svg v-else class="h-5 w-5 text-blue-300 hover:text-white transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                        </svg>
                      </button>
                    </div>
                    <p v-if="form.errors.password" class="text-sm text-red-300 font-medium animate-fade-in">{{ form.errors.password }}</p>
                  </div>
                    ...
                    <label class="flex items-center group cursor-pointer">
                      <div class="relative">
                        <input
                          ...
                          class="sr-only"
                        />
                        <div class="w-5 h-5 bg-white/5 border border-white/30 rounded group-hover:border-blue-400/50 transition-all duration-200"
                             :class="{ 'bg-blue-600 border-blue-600': form.remember.length }">
                          <svg v-if="form.remember.length" class="w-3 h-3 text-white absolute inset-0.5" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                          </svg>
                        </div>
                      </div>
                      <span class="ml-3 text-sm font-medium text-white/90 group-hover:text-white transition-colors duration-200">
                        Remember me
                      </span>
                    </label>
                      ...
                      >
                        ...
                        <div class="relative z-10 flex items-center">
                          <span v-if="form.processing" class="flex items-center">
                            ...
                            <span class="text-base">Authenticating...</span>
                          </span>
          ...
          <!-- Professional Footer -->
          <div class="text-center mt-8" :class="{ 'animate-fade-in-up animation-delay-600': mounted }">
