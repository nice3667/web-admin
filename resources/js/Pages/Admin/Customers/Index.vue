      ...
      <div class="relative z-10 min-h-screen flex flex-col items-center justify-start p-2 sm:p-3 md:p-4 bg-slate-900">
        <SectionMain class="w-full max-w-full">
          ...
          <div class="grid grid-cols-1 gap-6 mb-8 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4">
            <CardBox class="bg-slate-900/80 backdrop-blur-xl border border-white/10 shadow-xl rounded-2xl relative overflow-hidden text-white">
              <div class="absolute inset-0 bg-gradient-to-br from-blue-500 to-blue-600 opacity-10"></div>
              <div class="relative flex items-center justify-between">
                <div class="flex flex-col">
                  <span class="text-blue-200 text-sm font-medium mb-1">ลูกค้าทั้งหมด</span>
                  <span class="text-3xl font-bold text-blue-400">{{ stats.total_customers || 0 }}</span>
            ...
            <CardBox class="bg-slate-900/80 backdrop-blur-xl border border-white/10 shadow-xl rounded-2xl relative overflow-hidden text-white">
              ...
              <div class="relative flex items-center justify-between">
                <div class="flex flex-col">
                  <span class="text-green-200 text-sm font-medium mb-1">ลูกค้าที่ใช้งาน</span>
                  <span class="text-3xl font-bold text-green-400">{{ stats.active_customers || 0 }}</span>
            ...
            <CardBox class="bg-slate-900/80 backdrop-blur-xl border border-white/10 shadow-xl rounded-2xl relative overflow-hidden text-white">
              ...
              <div class="relative flex items-center justify-between">
                <div class="flex flex-col">
                  <span class="text-yellow-200 text-sm font-medium mb-1">Volume (Lots)</span>
                  <span class="text-3xl font-bold text-yellow-400">{{ formatNumber(stats.total_volume_lots || 0) }}</span>
            ...
            <CardBox class="bg-slate-900/80 backdrop-blur-xl border border-white/10 shadow-xl rounded-2xl relative overflow-hidden text-white">
              ...
              <div class="relative flex items-center justify-between">
                <div class="flex flex-col">
                  <span class="text-orange-200 text-sm font-medium mb-1">Reward (USD)</span>
                  <span class="text-3xl font-bold text-orange-400">${{ formatNumber(stats.total_reward_usd || 0) }}</span>
