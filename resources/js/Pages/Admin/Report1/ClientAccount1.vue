...
const formattedStats = computed(() => {
  return {
    ...
    total_volume_lots: Number(props.stats.total_volume_lots || 0).toFixed(4),
    total_volume_usd: Number(props.stats.total_volume_usd || 0).toFixed(4),
    total_profit: Number(props.stats.total_profit || 0).toFixed(4),
  };
});
